...
namespace MonomiPark.SlimeRancher.Persist
{
	public class WorldV17 : VersionedPersistedDataSet<WorldV16>
	{
		...
		public override uint Version => 17u;

		public WorldV17()
		{
		}

		public WorldV17(WorldV16 legacyData)
		{
		...
		{
			Dictionary<ExchangeDirector.OfferType, ExchangeOfferV03> dictionary = new Dictionary<ExchangeDirector.OfferType, ExchangeOfferV03>();
			if (expected.offer != null && expected.offer.hasOffer)
			{
				dictionary[ExchangeDirector.OfferType.GENERAL] = expected.offer;
			}
			TestUtil.AssertAreEqual(dictionary, actual.offers, delegate(ExchangeOfferV03 e, ExchangeOfferV03 a)
			{
				ExchangeOfferV03.AssertAreEqual(e, a);
			}, "offers");
			TestUtil.AssertAreEqual(expected.econSaturations, actual.econSaturations, delegate
