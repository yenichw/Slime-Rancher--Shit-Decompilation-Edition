...
{
	public class LandPlotV07 : VersionedPersistedDataSet<LandPlotV06>
	{
		...
		public LandPlotV07(LandPlotV06 legacyData)
		{
		...
		public static void AssertAreEqual(LandPlotV07 expected, LandPlotV07 actual)
		{
		...
		public static void AssertAreEqual(LandPlotV06 expected, LandPlotV07 actual)
		{
			TestUtil.AssertAreEqual(expected.upgrades, actual.upgrades, "upgrades");
			TestUtil.AssertAreEqual(expected.siloAmmo, actual.siloAmmo, delegate(List<AmmoDataV02> e, List<AmmoDataV02> a)
			{
		...
		protected override void UpgradeFrom(LandPlotV06 legacyData)
		{
