...
namespace MonomiPark.SlimeRancher.Persist
{
	public class LandPlotV05 : VersionedPersistedDataSet<LandPlotV04>
	{
		...
		public LandPlotV05(LandPlotV04 legacyData)
		{
			UpgradeFromLegacy(legacyData);
		}
		...
		public void UpgradeFromLegacy(LandPlotV04 legacyData)
		{
		...
		{
			List<LandPlotV05> list = new List<LandPlotV05>();
			foreach (LandPlotV04 legacy in legacyList)
			{
				LandPlotV05 landPlotV = new LandPlotV05();
		...
		public static List<LandPlotV05> UpgradeList(List<LandPlotV03> legacyList)
		{
			...
			foreach (LandPlotV03 legacy in legacyList)
			{
				...
				landPlotV.UpgradeFromLegacy(legacy);
				LandPlotV05 landPlotV2 = new LandPlotV05();
				landPlotV2.UpgradeFrom(landPlotV);
				list.Add(landPlotV2);
			}
			return list;
		}
