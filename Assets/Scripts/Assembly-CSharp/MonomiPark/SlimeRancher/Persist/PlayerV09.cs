...
{
	public class PlayerV09 : VersionedPersistedDataSet<PlayerV08>
	{
		public static readonly Vector3 RESET_POS = new Vector3(89.29f, 14.98f, -144.46f);

		public static readonly Vector3 RESET_ROT = new Vector3(0f, 24.736f, 0f);
		...
		public PlayerV09(PlayerV08 legacyData)
		{
		...
		public static PlayerV09 Load(BinaryReader reader)
		{
			PlayerV09 playerV = new PlayerV09();
			playerV.Load(reader.BaseStream);
			return playerV;
		}

		public static void AssertAreEqual(PlayerV09 expected, PlayerV09 actual)
		{
		...
		public static void AssertAreEqual(PlayerV08 expected, PlayerV09 actual)
		{
			Vector3V02.AssertAreEqual(expected.playerPos, actual.playerPos);
			Vector3V02.AssertAreEqual(expected.playerRotEuler, actual.playerRotEuler);
			for (int i = 0; i < expected.ammo.Count; i++)
		...
		protected override void UpgradeFrom(PlayerV08 legacyData)
		{
			...
			delayedProgress = new Dictionary<ProgressDirector.ProgressTrackerId, double>();
