...
{
	public class GameV11 : GamePersistedDataSet<GameV10>
	{
		...
		protected override void UpgradeFrom(GameV10 legacyData)
		{
			...
			appearances = new AppearancesV01();
		}

		public static void AssertAreEqual(GameV11 expected, GameV11 actual, bool allowActorMovement = false)
		{
		...
		public static void AssertAreEqual(GameV10 expected, GameV11 actual)
		{
			GameSummaryV04.AssertAreEqual(expected.summary, actual.summary);
			WorldV22.AssertAreEqual(expected.world, actual.world);
			GameAchieveV03.AssertAreEqual(expected.achieve, actual.achieve);
			...
			HolidayDirectorV02.AssertAreEqual(expected.holiday, actual.holiday);
			AppearancesV01.AssertAreEqual(new AppearancesV01(), actual.appearances);
		}
	}
}
