...
{
	public class OptionsV11 : VersionedPersistedDataSet<OptionsV10>
	{
		...
		protected override void UpgradeFrom(OptionsV10 legacyData)
		{
			...
			enabledTutorials = (legacyData.disableTutorials ? OptionsDirector.EnabledTutorials.NONE : OptionsDirector.EnabledTutorials.ALL);
		}
	}
}
