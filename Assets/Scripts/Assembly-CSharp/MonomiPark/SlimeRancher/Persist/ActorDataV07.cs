...
{
	public class ActorDataV07 : VersionedPersistedDataSet<ActorDataV06>
	{
		...
		public ActorDataV07(ActorDataV06 legacyData)
		{
		...
		public static void AssertAreEqual(ActorDataV07 expected, ActorDataV07 actual, bool allowActorMovement = false)
		{
		...
		public static void AssertAreEqual(ActorDataV06 expected, ActorDataV07 actual)
		{
			Vector3V02.AssertAreEqual(expected.pos, actual.pos);
		...
		protected override void UpgradeFrom(ActorDataV06 legacyData)
		{
			pos = legacyData.pos;
			rot = legacyData.rot;
