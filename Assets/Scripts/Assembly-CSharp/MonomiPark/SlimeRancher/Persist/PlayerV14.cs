...
{
	public class PlayerV14 : VersionedPersistedDataSet<PlayerV13>
	{
		public int health;
		...
		public PlayerV14(PlayerV13 legacyData)
		{
		...
		protected override void LoadData(BinaryReader reader)
		{
			...
			decorizer = PersistedDataSet.LoadPersistable<DecorizerV01>(reader);
		}
		...
		protected override void WriteData(BinaryWriter writer)
		{
			...
			PersistedDataSet.WritePersistable(writer, decorizer);
		}

		public static PlayerV14 Load(BinaryReader reader)
		{
			PlayerV14 playerV = new PlayerV14();
			playerV.Load(reader.BaseStream);
			return playerV;
		}

		public static void AssertAreEqual(PlayerV14 expected, PlayerV14 actual)
		{
			...
			DecorizerV01.AssertAreEqual(expected.decorizer, actual.decorizer);
		}
		...
		public static void AssertAreEqual(PlayerV13 expected, PlayerV14 actual)
		{
			Vector3V02.AssertAreEqual(expected.playerPos, actual.playerPos);
			...
			DecorizerV01.AssertAreEqual(actual.decorizer, DecorizerV01.FromLegacy());
		}

		protected override void UpgradeFrom(PlayerV13 legacyData)
		{
			...
			endGameTime = legacyData.endGameTime;
			decorizer = DecorizerV01.FromLegacy();
		}
