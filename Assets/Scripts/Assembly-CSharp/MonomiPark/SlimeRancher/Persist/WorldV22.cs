...
namespace MonomiPark.SlimeRancher.Persist
{
	public class WorldV22 : VersionedPersistedDataSet<WorldV21>
	{
		...
		public override uint Version => 22u;

		public WorldV22()
		{
		}

		public WorldV22(WorldV21 legacyData)
		{
		...
		protected override void LoadData(BinaryReader reader)
		{
			...
			placedGadgets = LoadDictionary(reader, (BinaryReader r) => r.ReadString(), (BinaryReader r) => PlacedGadgetV08.Load(r));
			...
			glitch = PersistedDataSet.LoadPersistable<GlitchSlimulationV02>(reader);
		}
		...
		protected override void WriteData(BinaryWriter writer)
		{
			...
			{
				w.Write(s);
			}, delegate(BinaryWriter w, PlacedGadgetV08 pg)
			{
			...
			PersistedDataSet.WritePersistable(writer, glitch);
		}

		public static WorldV22 Load(BinaryReader reader)
		{
			WorldV22 worldV = new WorldV22();
		...
		public static void AssertAreEqual(WorldV22 expected, WorldV22 actual)
		{
			...
			TestUtil.AssertAreEqual(expected.placedGadgets, actual.placedGadgets, delegate(PlacedGadgetV08 e, PlacedGadgetV08 a)
			{
				PlacedGadgetV08.AssertAreEqual(e, a);
			}, "placedGadgets");
		...
		public static void AssertAreEqual(WorldV21 expected, WorldV22 actual)
		{
			...
			TestUtil.AssertVersionedAreEqual(expected.placedGadgets, actual.placedGadgets, delegate(PlacedGadgetV07 e, PlacedGadgetV08 a)
			{
				PlacedGadgetV08.AssertAreEqual(e, a);
			}, "placedGadgets");
			TestUtil.AssertAreEqual(expected.treasurePods, actual.treasurePods, delegate(TreasurePodV01 e, TreasurePodV01 a)
			...
			TestUtil.AssertAreEqual(expected.echoNoteGordos, actual.echoNoteGordos, delegate(EchoNoteGordoV01 e, EchoNoteGordoV01 a)
			{
				EchoNoteGordoV01.AssertAreEqual(e, a);
			}, "echoNoteGordos");
		...
		protected override void UpgradeFrom(WorldV21 legacyData)
		{
			...
			placedGadgets = ((legacyData.placedGadgets != null) ? legacyData.placedGadgets.ToDictionary((KeyValuePair<string, PlacedGadgetV07> p) => p.Key, (KeyValuePair<string, PlacedGadgetV07> p) => new PlacedGadgetV08(p.Value)) : null);
