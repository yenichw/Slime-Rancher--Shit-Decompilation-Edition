...
public class AvailBlueprintPopupUI : PopupUI<GadgetDefinition>, PopupDirector.Popup
{
	...
	{
		GameObject obj = UnityEngine.Object.Instantiate(SRSingleton<SceneContext>.Instance.GadgetDirector.availBlueprintPopupPrefab);
		obj.GetComponent<AvailBlueprintPopupUI>().Init(gadgetDefintion);
		return obj;
	}
}
