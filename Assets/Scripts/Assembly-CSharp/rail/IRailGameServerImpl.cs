...
namespace rail
{
	public class IRailGameServerImpl : RailObject, IRailGameServer, IRailComponent
	{
		...
		public virtual RailResult GetGameServerFullname(out string fullname)
		{
			...
			{
				fullname = RAIL_API_PINVOKE.RailString_c_str(intPtr);
				RAIL_API_PINVOKE.delete_RailString(intPtr);
			}
		}
		...
		{
			return RAIL_API_PINVOKE.IRailGameServer_SetZoneID(swigCPtr_, zone_id);
		}

		public virtual ulong GetZoneID()
		{
			return RAIL_API_PINVOKE.IRailGameServer_GetZoneID(swigCPtr_);
		}

		public virtual bool SetChannelID(ulong channel_id)
		{
			return RAIL_API_PINVOKE.IRailGameServer_SetChannelID(swigCPtr_, channel_id);
		}

		public virtual ulong GetChannelID()
		{
			return RAIL_API_PINVOKE.IRailGameServer_GetChannelID(swigCPtr_);
		}
		...
		public virtual bool SetSpectatorHost(string specator_host)
		{
			return RAIL_API_PINVOKE.IRailGameServer_SetSpectatorHost(swigCPtr_, specator_host);
		}
		...
		public virtual bool GetSpectatorHost(out string specator_host)
		{
			...
			{
				specator_host = RAIL_API_PINVOKE.RailString_c_str(intPtr);
				RAIL_API_PINVOKE.delete_RailString(intPtr);
			}
		}
