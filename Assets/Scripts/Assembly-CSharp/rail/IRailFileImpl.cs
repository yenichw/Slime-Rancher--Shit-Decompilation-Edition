...
namespace rail
{
	public class IRailFileImpl : RailObject, IRailFile, IRailComponent
	{
		...
		{
			return RAIL_API_PINVOKE.IRailFile_GetFilename(swigCPtr_);
		}

		public virtual uint Read(byte[] buff, uint bytes_to_read, out int result)
		{
		...
		public virtual uint Write(byte[] buff, uint bytes_to_write, out int result)
		{
