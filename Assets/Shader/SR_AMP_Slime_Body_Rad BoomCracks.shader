Shader "SR/AMP/Slime/Body/Rad BoomCracks" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.z = floor(tmp0.z);
                tmp0.x = tmp0.z * 0.1757812 + tmp0.x;
                ...
                tmp2.xyz = tmp2.xyz - tmp4.xyz;
                tmp0.xzw = tmp0.zzz * tmp2.xyz + tmp4.xyz;
                tmp2.xyz = tmp0.yyy * float3(0.625, 0.625, 0.625) + tmp0.xzw;
                tmp2.xyz = -tmp3.xyz * tmp0.xzw + tmp2.xyz;
                tmp0.xyz = tmp0.xzw * tmp3.xyz;
                tmp0.xyz = tmp2.xyz * float3(0.8, 0.8, 0.8) + tmp0.xyz;
                tmp2.xyz = tmp0.xyz * float3(1.5, 1.5, 1.5);
                tmp0.w = dot(tmp2.xyz, float3(0.299, 0.587, 0.114));
                tmp0.xyz = -tmp0.xyz * float3(1.5, 1.5, 1.5) + tmp0.www;
                ...
                tmp0.xyz = tmp0.xyz * float3(0.75, 0.75, 0.75) + -tmp2.xyz;
                tmp0.xyw = _Char.xxx * tmp0.yzx + tmp2.yzx;
                ...
                tmp1.zw = tmp1.xx * float2(10.0, 10.0) + float2(-0.8, -0.333);
                tmp1.x = tmp1.x * 40.0;
                tmp1.x = saturate(tmp1.x);
                tmp1.zw = saturate(tmp1.zw * float2(5.0, 2.994012));
                tmp2.xy = tmp1.zw * float2(-2.0, -2.0) + float2(3.0, 3.0);
