Shader "SR/AMP/Slime/Face/Eyes Blush" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xy = _EyeSmoothStepBase.xx - float2(0.1, 0.025);
                tmp0.w = tmp3.z - tmp1.y;
                ...
                tmp0.xy = tmp0.ww * tmp0.xy + tmp1.zw;
                tmp4 = tex2D(_FaceAtlas, tmp1.zw);
                tmp1.xy = tmp4.xx - tmp1.xy;
                tmp1.xy = saturate(tmp1.xy * float2(5.0, 20.0));
                tmp4 = tex2D(_FaceAtlas, tmp0.xy);
                tmp0.xy = tmp1.xy * float2(-2.0, -2.0) + float2(3.0, 3.0);
                tmp1.xy = tmp1.xy * tmp1.xy;
                tmp0.xy = tmp0.xy * tmp1.xy;
                tmp0.w = tmp4.y * tmp0.x;
                tmp1.xyz = tmp0.www * _EyeGreen.xyz + tmp3.xyz;
                tmp0.w = tmp0.y * inp.color.x;
                tmp1.xyz = tmp1.xyz * tmp0.www;
                tmp0.xzw = tmp0.zzz * tmp0.xxx + tmp1.xyz;
                tmp0.y = inp.color.x * tmp0.y + -0.05;
                tmp0.y = saturate(tmp0.y * 9.999999);
                tmp0.xzw = -tmp2.xyz * tmp2.www + tmp0.xzw;
                ...
                o.sv_target.w = saturate(tmp0.y + tmp2.w);
                return o;
			}
			ENDCG
		}
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.x = tmp0.x * tmp0.y;
                tmp0.x = inp.color.x * tmp0.x + -0.05;
                tmp0.x = saturate(tmp0.x * 9.999999);
                tmp0.y = tmp0.x * -2.0 + 3.0;
                tmp0.x = tmp0.x * tmp0.x;
                tmp0.x = tmp0.x * tmp0.y;
