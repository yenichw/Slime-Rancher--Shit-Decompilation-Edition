Shader "SR/AMP/Slime/Body/Normal Stripe" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.zw = _NormalUV1.xx * tmp0.zw + inp.texcoord.xy;
                tmp0.zw = _Time.yy * _NormalPanSpeed + tmp0.zw;
                tmp2 = tex2D(_Normal, tmp0.zw);
                tmp0.xy = tmp0.xy + tmp1.yz;
                tmp0 = tex2D(_Stripe2Texture, tmp0.xy);
                tmp0.x = tmp0.x - _StripeRemap2.x;
                tmp0.yz = _StripeRemap2.wy - _StripeRemap2.zx;
                tmp0.x = tmp0.y * tmp0.x;
                tmp0.x = tmp0.x / tmp0.z;
                tmp0.x = saturate(tmp0.x + _StripeRemap2.z);
                tmp0.x = tmp0.x * tmp1.x;
                tmp0.yzw = inp.texcoord.yxy - float3(1.0, 0.5, -0.0);
                tmp0.z = dot(tmp0.xy, tmp0.xy);
                tmp0.z = sqrt(tmp0.z);
                tmp0.z = tmp0.z - 0.25;
                tmp0.yz = saturate(tmp0.yz * float2(-1.333333, 1.333333));
                tmp0.w = tmp0.z * -2.0 + 3.0;
                tmp0.z = tmp0.z * tmp0.z;
                tmp0.z = tmp0.w * tmp0.z + -inp.texcoord.y;
                tmp0.z = _LightingUVHorizontalAdjust * tmp0.z + inp.texcoord.y;
                tmp0.z = tmp0.z - 0.5;
                tmp0.w = tmp0.z * _LightingUVContribution;
                tmp0.z = _LightingUVContribution * tmp0.z + 0.5;
                ...
                tmp1.xyz = tmp0.yyy * tmp1.xyz + float3(0.0, 0.0, 1.0);
                ...
                tmp0.y = rsqrt(tmp0.y);
                tmp1.x = tmp2.y * tmp0.y + 1.0;
                tmp1.yzw = tmp0.yyy * tmp2.xyz;
                tmp0.y = saturate(tmp1.x * 0.75 + -0.5);
                tmp1.x = 1.0 - tmp0.y;
                ...
                tmp1.xyz = tmp1.xyz - tmp3.xyz;
                tmp0.xyw = tmp0.yyy * tmp1.xyz + tmp3.xyz;
                tmp1.xyz = tmp0.zzz * float3(0.625, 0.625, 0.625) + tmp0.xyw;
                tmp1.xyz = -tmp2.xyz * tmp0.xyw + tmp1.xyz;
