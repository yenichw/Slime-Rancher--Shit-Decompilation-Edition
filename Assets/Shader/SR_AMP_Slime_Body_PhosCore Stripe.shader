Shader "SR/AMP/Slime/Body/PhosCore Stripe" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.x = tmp1.x * tmp1.y;
                tmp1.y = tmp1.x * 0.625;
                tmp0.x = saturate(tmp0.x * tmp0.y + tmp1.y);
                tmp0.y = tmp1.x * 0.625 + tmp0.y;
                tmp0.y = _Alpha * 0.5 + tmp0.y;
                tmp0.y = saturate(tmp0.y + 0.5);
                tmp0.x = tmp0.x - tmp0.w;
                tmp0.x = _BodyLightingContribution * tmp0.x + tmp0.w;
                tmp1.y = saturate(tmp0.x * 2.0 + -1.0);
                ...
                tmp1.w = tmp0.x * 0.5;
                tmp2.x = -tmp0.x * 0.5 + inp.texcoord4.y;
                ...
                tmp2.xy = tmp0.ww * tmp2.zw + tmp2.xy;
                tmp0.x = tmp0.w * 3.0 + -_Time.y;
                tmp0.x = frac(tmp0.x);
                tmp0.x = tmp0.x * 2.0 + -1.0;
                tmp0.x = abs(tmp0.x) * _RadExoticCore;
                tmp0.xw = tmp0.xx * float2(0.4, 0.4) + float2(0.4, -0.1);
                tmp2 = tex2D(_RefractionSlime, tmp2.xy);
                tmp1.xyz = tmp1.xyz - tmp2.xyz;
                tmp1.xyz = tmp0.yyy * tmp1.xyz + tmp2.xyz;
                tmp2.xy = _RadExoticCore.xx * float2(1.46, 0.11) + float2(1.0, -1.0);
                tmp0.y = tmp0.z * tmp2.y;
                ...
                tmp3.xyz = tmp0.xxx * _GlowTop.xyz;
                tmp0.yzw = tmp3.xyz * float3(0.334, 0.334, 0.334) + tmp0.yzw;
                tmp2.xyz = tmp2.xyz - tmp0.yzw;
                tmp0.yzw = tmp0.xxx * tmp2.xyz + tmp0.yzw;
                ...
                tmp2.xyz = max(tmp1.xyz, tmp2.xyz);
                tmp0.yzw = tmp0.yzw - tmp2.xyz;
                tmp0.xyz = tmp0.xxx * tmp0.yzw + tmp2.xyz;
                tmp0.xyz = tmp0.xyz - tmp1.xyz;
                o.sv_target.xyz = _GlowTop.www * tmp0.xyz + tmp1.xyz;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
