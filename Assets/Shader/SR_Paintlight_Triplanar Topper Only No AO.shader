Shader "SR/Paintlight/Triplanar Topper Only No AO" {
	Properties {
	...
	SubShader {
		...
		Pass {
			Name "FORWARD"
			Tags { "LIGHTMODE" = "FORWARDBASE" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
		...
		Pass {
			Name "FORWARD_DELTA"
			Tags { "LIGHTMODE" = "FORWARDADD" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
		...
		Pass {
			Name "ShadowCaster"
			Tags { "LIGHTMODE" = "SHADOWCASTER" "RenderType" = "TransparentCutout" "SHADOWSUPPORT" = "true" }
			Offset 1, 1
			GpuProgramID 164150
			CGPROGRAM
			#pragma vertex vert
