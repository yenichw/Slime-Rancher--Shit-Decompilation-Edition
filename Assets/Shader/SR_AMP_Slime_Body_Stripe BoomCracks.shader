Shader "SR/AMP/Slime/Body/Stripe BoomCracks" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.x = tmp1.x * tmp1.y;
                tmp1.y = tmp1.x * 0.625;
                tmp0.y = saturate(tmp0.x * tmp0.y + tmp1.y);
                tmp0.y = tmp0.y - tmp0.w;
                tmp0.y = _BodyLightingContribution * tmp0.y + tmp0.w;
                tmp0.w = tmp0.w * -1.5 + 1.5;
                tmp1.y = saturate(tmp0.y * 2.0 + -1.0);
                ...
                tmp2.xyz = tmp1.xxx * float3(0.625, 0.625, 0.625) + tmp1.yzw;
                tmp2.xyz = -tmp3.xyz * tmp1.yzw + tmp2.xyz;
                tmp1.xyz = tmp1.yzw * tmp3.xyz;
                ...
                tmp0.y = _CrackNoiseSpeed * _Time.y;
                tmp4.xy = tmp0.yy * float2(0.06, -3.0) + tmp4.xy;
                ...
                tmp2.x = tmp0.y * 6.0 + 0.0;
                tmp1.y = tmp1.w - tmp1.y;
                tmp1.y = tmp1.y / tmp2.x;
                tmp1.y = tmp1.y + tmp1.z;
                tmp1.yzw = abs(tmp1.yyy) + float3(1.0, 0.6666667, 0.3333333);
                ...
                tmp2.x = _CrackAmount + 1.0;
                tmp0.y = tmp0.y * tmp2.x;
                tmp1.yzw = tmp0.yyy * tmp1.yzw + float3(1.0, 1.0, 1.0);
                tmp0.x = tmp0.x * tmp0.w;
                tmp0.y = saturate(tmp0.w * 40.0);
                tmp0.xw = tmp0.xx * float2(10.0, 10.0) + float2(-0.8, -0.333);
                tmp0.xw = saturate(tmp0.xw * float2(5.0, 2.994012));
                tmp2.xy = tmp0.xw * float2(-2.0, -2.0) + float2(3.0, 3.0);
                tmp0.xw = tmp0.xw * tmp0.xw;
                tmp0.xw = tmp0.xw * tmp2.xy;
                tmp0.x = tmp0.w * 0.5 + tmp0.x;
                tmp0.w = 1.0 - tmp0.x;
                tmp2.x = 1.0 - tmp4.x;
                tmp0.w = tmp0.w / tmp2.x;
                tmp0.w = saturate(1.0 - tmp0.w);
                tmp0.w = tmp0.x * 0.667 + tmp0.w;
                ...
                tmp6.xyz = tmp0.www * tmp3.yzw + tmp5.xyz;
                tmp0.w = log(tmp0.z);
                tmp0.w = tmp0.w * 0.9;
                tmp0.w = exp(tmp0.w);
                tmp0.w = tmp0.w * -3.0 + 1.0;
                tmp2.x = tmp0.w * _CrackAmount;
                tmp3.yzw = tmp2.xxx * tmp3.yzw + tmp5.xyz;
                tmp3.yzw = _CrackAmount.xxx * tmp0.www + tmp3.yzw;
                tmp3.yzw = saturate(tmp3.yzw - float3(1.0, 1.0, 1.0));
                tmp3.yzw = tmp6.xyz * tmp0.xxx + tmp3.yzw;
                tmp3.yzw = tmp3.yzw + tmp3.yzw;
                tmp0.x = inp.texcoord.y * 0.5 + 0.5;
                tmp5.xyz = _CrackAmount.xxx * float3(-0.4, -1.3, -0.25) + float3(1.0, 2.0, 1.0);
                tmp0.x = tmp0.z * tmp0.x + -tmp5.x;
                ...
                tmp0.xzw = tmp2.xyz * tmp0.xxx + tmp3.yzw;
                tmp2.x = tmp0.y * -2.0 + 3.0;
                tmp0.y = tmp0.y * tmp0.y;
                tmp0.y = tmp0.y * tmp2.x;
                tmp0.y = tmp0.y * -0.05 + 1.0;
                tmp0.y = tmp0.y * tmp1.x;
                tmp0.y = tmp5.z * tmp0.y;
                o.sv_target.xyz = tmp0.yyy * tmp1.yzw + tmp0.xzw;
                o.sv_target.w = 1.0;
                return o;
			}
			ENDCG
