Shader "SR/UI/Grayscale" {
	Properties {
		...
		_LightenFactor ("Lighten Factor", Range(0, 2)) = 1
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = tmp1.xxx * _LightenFactor.xxx + -tmp0.xyz;
                o.sv_target.xyz = _GrayscaleAmount.xxx * tmp1.xyz + tmp0.xyz;
