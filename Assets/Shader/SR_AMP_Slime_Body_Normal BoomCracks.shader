Shader "SR/AMP/Slime/Body/Normal BoomCracks" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.xyz = tmp1.xyz - tmp4.xyz;
                tmp0.xzw = tmp0.zzz * tmp1.xyz + tmp4.xyz;
                ...
                tmp1.xyz = tmp1.xyz * float3(0.5, 0.5, 0.5) + tmp0.xyz;
                ...
                tmp4.xy = inp.texcoord.xy * _CrackNoise_ST.xy + _CrackNoise_ST.zw;
                tmp0.w = _CrackNoiseSpeed * _Time.y;
                tmp4.xy = tmp0.ww * float2(0.06, -3.0) + tmp4.xy;
                tmp4 = tex2D(_CrackNoise, tmp4.xy);
                tmp0.w = tmp4.x * 2.0 + -1.0;
                tmp0.w = tmp0.w * _CrackAmount;
                tmp2.xyz = tmp0.www * float3(0.03, 0.03, 0.03) + tmp2.xyz;
                tmp2 = texCUBE(_Cracks, tmp2.xyz);
                tmp0.w = tmp2.x * -0.25 + 1.0;
                tmp1.xyz = tmp1.xyz * tmp0.www;
                tmp1.xyz = tmp1.xyz * float3(0.75, 0.75, 0.75) + -tmp0.xyz;
                tmp0.xyw = _Char.xxx * tmp1.yzx + tmp0.yzx;
                ...
                tmp1 = tmp1.xxxx * tmp6 + tmp5;
                tmp2.y = tmp0.w >= tmp1.x;
                tmp2.y = tmp2.y ? 1.0 : 0.0;
                tmp0.xyz = tmp1.xyw;
                tmp1.xyw = tmp0.wyx;
                tmp1 = tmp1 - tmp0;
                tmp0 = tmp2.yyyy * tmp1 + tmp0;
                ...
                tmp1.y = _CrackAmount + 1.0;
                tmp1.x = tmp1.y * tmp1.x;
                tmp0.yzw = tmp1.xxx * tmp0.yzw + float3(1.0, 1.0, 1.0);
                tmp1.x = _CrackColor.y >= _CrackColor.z;
                tmp1.x = tmp1.x ? 1.0 : 0.0;
                ...
                tmp5 = tmp5 - tmp6;
                tmp1 = tmp1.xxxx * tmp5.xywz + tmp6.xywz;
                tmp2.y = _CrackColor.x >= tmp1.x;
                tmp2.y = tmp2.y ? 1.0 : 0.0;
                tmp5.z = tmp1.w;
                tmp1.w = _CrackColor.x;
                tmp5.xyw = tmp1.wyx;
                tmp5 = tmp5 - tmp1;
                tmp1 = tmp2.yyyy * tmp5 + tmp1;
                tmp2.y = min(tmp1.y, tmp1.w);
                tmp2.y = tmp1.x - tmp2.y;
                tmp2.z = tmp2.y * 6.0 + 0.0;
                tmp1.y = tmp1.w - tmp1.y;
                tmp1.y = tmp1.y / tmp2.z;
                tmp1.y = tmp1.y + tmp1.z;
                tmp1.z = abs(tmp1.y) + _CrackColorRange;
                tmp1.y = abs(tmp1.y) - _CrackColorRange;
                tmp4.yzw = tmp1.yyy + float3(1.0, 0.6666667, 0.3333333);
                ...
                tmp1.yzw = tmp1.zzz + float3(1.0, 0.6666667, 0.3333333);
                ...
                tmp1.yzw = tmp2.yyy * tmp1.yzw + float3(1.0, 1.0, 1.0);
                tmp2.yzw = tmp2.yyy * tmp4.yzw + float3(1.0, 1.0, 1.0);
                tmp4.yzw = tmp1.xxx * tmp1.yzw + -_CrackColor.xyz;
                tmp3.w = 1.0 - tmp4.x;
                tmp4.yzw = tmp3.www * tmp4.yzw + _CrackColor.xyz;
                tmp5.xyz = -tmp1.xxx * tmp2.yzw + _CrackColor.xyz;
                tmp2.yzw = tmp1.xxx * tmp2.yzw;
                tmp5.xyz = tmp3.www * tmp5.xyz + tmp2.yzw;
                ...
                tmp5.w = dot(tmp6.xyz, tmp3.xyz);
                tmp3.x = dot(tmp7.xyz, tmp3.xyz);
                tmp3.x = 1.0 - tmp3.x;
                tmp3.y = 1.0 - tmp5.w;
                tmp3.y = tmp3.y * -1.5 + 1.5;
                tmp2.x = tmp2.x * tmp3.y;
                tmp2.x = tmp2.x * _CrackAmount;
                tmp3.y = log(tmp3.x);
                tmp3.y = tmp3.y * 0.9;
                tmp3.y = exp(tmp3.y);
                tmp3.y = tmp3.y * -3.0 + 1.0;
                tmp3.z = tmp3.y * _CrackAmount;
                tmp6.xyz = tmp3.zzz * tmp4.yzw + tmp5.xyz;
                tmp6.xyz = _CrackAmount.xxx * tmp3.yyy + tmp6.xyz;
                tmp6.xyz = saturate(tmp6.xyz - float3(1.0, 1.0, 1.0));
                tmp3.yz = tmp2.xx * float2(10.0, 10.0) + float2(-0.8, -0.333);
                tmp2.x = tmp2.x * 40.0;
                tmp2.x = saturate(tmp2.x);
                tmp3.yz = saturate(tmp3.yz * float2(5.0, 2.994012));
                tmp7.xy = tmp3.yz * float2(-2.0, -2.0) + float2(3.0, 3.0);
                tmp3.yz = tmp3.yz * tmp3.yz;
                tmp3.yz = tmp3.yz * tmp7.xy;
                tmp3.y = tmp3.z * 0.5 + tmp3.y;
                tmp3.z = 1.0 - tmp3.y;
                tmp3.z = tmp3.z / tmp3.w;
                tmp3.z = saturate(1.0 - tmp3.z);
                tmp3.z = tmp3.y * 0.667 + tmp3.z;
                tmp4.yzw = tmp3.zzz * tmp4.yzw + tmp5.xyz;
                tmp3.yzw = tmp4.yzw * tmp3.yyy + tmp6.xyz;
                tmp3.yzw = tmp3.yzw + tmp3.yzw;
                tmp4.yzw = tmp1.xxx * tmp1.yzw + -tmp2.yzw;
                tmp1.xyz = tmp1.yzw * tmp1.xxx;
                tmp2.yzw = _CrackAmount.xxx * tmp4.yzw + tmp2.yzw;
                ...
                tmp1.xyz = tmp2.yzw * float3(2.0, 2.0, 2.0) + tmp1.xyz;
                tmp1.w = inp.texcoord.y * 0.5 + 0.5;
                tmp2.yzw = _CrackAmount.xxx * float3(-0.4, -1.3, -0.25) + float3(1.0, 2.0, 1.0);
                tmp1.w = tmp3.x * tmp1.w + -tmp2.y;
                ...
                tmp1.w = tmp2.x * -2.0 + 3.0;
                tmp2.x = tmp2.x * tmp2.x;
                tmp1.w = tmp1.w * tmp2.x;
                tmp1.w = tmp1.w * -0.05 + 1.0;
