Shader "SR/AMP/Slime/Body/Rad Stripe" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.xyz = tmp2.xyz * tmp0.zzz + float3(0.0, 1.0, 0.0);
                ...
                tmp0.y = tmp0.z * tmp0.y;
                tmp0.y = tmp0.y * 5.688889;
                tmp0.y = floor(tmp0.y);
                tmp0.x = saturate(tmp0.y * 0.1757812 + tmp0.x);
                ...
                tmp1.xyz = tmp1.xyz - tmp3.xyz;
                tmp0.xyz = tmp0.yyy * tmp1.xyz + tmp3.xyz;
                tmp1.xyz = tmp0.www * float3(0.625, 0.625, 0.625) + tmp0.xyz;
