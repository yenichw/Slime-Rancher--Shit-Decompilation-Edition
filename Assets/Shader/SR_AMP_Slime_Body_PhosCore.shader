Shader "SR/AMP/Slime/Body/PhosCore" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp1.yw = tmp1.yz * float2(3.0, 0.5);
                ...
                tmp3 = tex2D(_RefractionSlime, tmp1.zw);
                tmp0.yzw = tmp0.yzw - tmp3.xyz;
                tmp0.xyz = tmp0.xxx * tmp0.yzw + tmp3.xyz;
                tmp1.xz = _RadExoticCore.xx * float2(1.46, 0.11) + float2(1.0, -1.0);
